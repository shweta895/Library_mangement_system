...
if choice == "HOME":
    ...
    if st.session_state['login'] == False:
        ...
        btn = st.button("Login")
        if btn:
            mydb = mysql.connector.connect(host="localhost", user="root", password="newrootpassword", database="lms", port = "3306" )
            c = mydb.cursor()
    ...
    if st.session_state['login']:
        ...
        if choice2 == "View All Books":
            ...
            def onclick(books):
                ...
                mydb2 = mysql.connector.connect(host="localhost", user="root", password="newrootpassword", database="lms", port = "3306" )
                c2 = mydb2.cursor()
